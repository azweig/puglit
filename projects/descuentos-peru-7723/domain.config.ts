...
const config: DomainConfig = {
  ...
  "identity": {
    ...
    "logoSvg": "<svg viewBox=\"0 0 64 64\" xmlns=\"http://www.w3.org/2000/svg\">\n  <circle cx=\"32\" cy=\"32\" r=\"28\" fill=\"#FF5733\"/>\n  <path d=\"M32 12c-7.7 0-14 6.3-14 14s14 26 14 26 14-18.3 14-26-6.3-14-14-14zm0 20a6 6 0 1 1 0-12 6 6 0 0 1 0 12z\" fill=\"#900C3F\"/>\n</svg>",
    "palette": [
      {
        "hex": "#FF5733",
        "label": "Primary"
    ...
    "brandColor": "#FF5733",
    "accentColor": "#900C3F",
    "logoConcept": "Un diseño moderno que combina las iniciales 'DP' con un ícono de ubicación para reflejar la naturaleza geolocalizada de los descuentos.",
    "logoMonogram": "DP",
    "targetMarkets": [],
