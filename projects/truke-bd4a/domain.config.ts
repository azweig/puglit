...
const config: DomainConfig = {
  ...
  "identity": {
    "name": "Truke",
    "domain": "truke.app",
    "logoSvg": "<svg viewBox=\"0 0 64 64\" xmlns=\"http://www.w3.org/2000/svg\">\n  <path d=\"M32 12L18 26h8v12h-8l14 14 14-14h-8V26h8L32 12z\" fill=\"#FF6F61\"/>\n  <path d=\"M32 20l-6 6h4v12h-4l6 6 6-6h-4V26h4l-6-6z\" fill=\"#F5A623\"/>\n</svg>",
    "palette": [
      {
        "hex": "#FF6F61",
        "label": "primary"
    ...
    "brandColor": "#FF6F61",
    "accentColor": "#F5A623",
    "logoConcept": "Una 'T' estilizada en forma de flechas opuestas, simbolizando intercambio.",
    "logoMonogram": "T",
    "targetMarkets": [],
