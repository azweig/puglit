...
const config: DomainConfig = {
  ...
  "identity": {
    ...
    "brandColor": "#FF5733",
    "accentColor": "#900C3F",
    "logoConcept": "Un monograma estilizado 'DP' que simboliza conexión y descubrimiento de beneficios.",
    "logoMonogram": "DP",
    "targetMarkets": [],
