...
const config: DomainConfig = {
  ...
  "landing": {
    ...
    "finalCta": {
      ...
      "headline": "¿List@ para probar Noteflow?"
    },
    "valueProps": [
      {
        "body": "Viene en Noteflow desde el día uno — sin código pegamento.",
        "title": "Notas rápidas"
      },
      {
  ...
  "identity": {
    "name": "Noteflow",
    "domain": "noteflow.app",
    "logoSvg": "<svg viewBox=\"0 0 64 64\" xmlns=\"http://www.w3.org/2000/svg\">\n  <path d=\"M12 12h32v32H12z\" fill=\"#8B5CF6\"/>\n  <path d=\"M44 44L32 32l12-12v24z\" fill=\"#F59E0B\"/>\n  <path d=\"M44 12L32 24l-4-4L40 8h4v4z\" fill=\"#F59E0B\"/>\n</svg>",
    "palette": [
      {
        "hex": "#8B5CF6",
        "label": "P"
