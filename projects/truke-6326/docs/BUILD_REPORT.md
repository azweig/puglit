...
- Rutas API: app/api/items/route.ts, app/api/feed/route.ts, app/api/swipes/route.ts, app/api/matches/route.ts, app/api/messages/route.ts, app/api/messages/route.ts
- Pantallas: /, /publicar, /matches, /chat/[matchId], /publicar, /matches, /chat/[matchId]
